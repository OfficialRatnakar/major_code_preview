...
// Temporarily comment out QuizList import
    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          {/* Temporarily comment out quiz list until backend is ready */}
          {/* {isAlreadyEnrolled && (
            <div className="pb-10">
              <h3 className="text-xl font-semibold text-gray-800">Course Quizzes</h3>
              <div className="mt-4">
                <QuizList courseId={courseData._id} />
              </div>
            </div>
          )} */}
        </div>
